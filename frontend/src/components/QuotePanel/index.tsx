...
export function QuotePanel({ quote, onClose, onRequote, requoting }: QuotePanelProps) {
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="h-12 flex-shrink-0 border-b border-slate-200 flex items-center px-4 gap-2">
        ...
        {quote ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Ask for a quote in the chat, or click "Get Quote" on an uncovered risk to see it here.
            </p>
          </div>
        )}
      </div>
